...
layout(buffer_reference, std430, buffer_reference_align = 16) readonly buffer F32V4ReadOnly {
    vec4 v[];
};
layout(buffer_reference, std430, buffer_reference_align = 16) buffer F32V4ReadWrite {
    vec4 v[];
};
// Scalar-typed alias for bounds-checked / edge loads.
layout(buffer_reference, std430, buffer_reference_align = 4) readonly buffer F32ReadOnly {
    float v[];
};
layout(buffer_reference, std430, buffer_reference_align = 4) buffer F32ReadWrite {
    float v[];
};
